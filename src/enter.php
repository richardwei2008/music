...
<div id="messageMask" onClick="document.getElementById('messageMask').style.display='none';"  class="message-mask">
 ...
 <div data-role="page" id="view-enter" data-theme="d" class="view-enter-page">
        <div data-role="content" class="ui-content-custom ">
            <div class="enter-page-fill"></div>
            <div class="enter-page-content">
            <div class="view-enter-page-link-area">
                <a href="#view-upload" class="link-upload-page"></a>
                 <a id="button-mine" href="javascript:void(0)" class="link-mine-page"></a>
                         <a id="button-more" href="javascript:void(0)" class="link-more-page"></a>
                <a href="#view-rule" class="link-rule-page"></a>
            </div>
            </div>
        </div>
    </div>

<div data-role="page" id="view-upload" data-theme="d" class="view-upload-page">
        <div data-role="content" class="ui-content-custom ">
            <div class="upload-page-fill"></div>
            <div class="upload-page-content">
                <form id="upload_form" enctype="multipart/form-data" method="post" action="server/php/service/UploadService.php">
                    <div class="image-op-section">
                        <div class="image-preview-section image-preview-section-height">
                            <div class="image-preview">
                                <div id="main-image-preview" class="main-image-preview">
                                    <img id="largePreview" class="largePreview" width="100%">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="upload-preview">
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide swiper-slide-chosen">
                                            <div id="preview-area1" class="preview-item">
                                                <div class="fileupload-icon">
                                                    <i class="glyphicon glyphicon-plus fileupload-icon-inner"></i>
                                                </div>
                                                <div class="fileupload-button">
                                                    <input id="fileupload1" data-role="none" type="file" name="fileupload1" class="fileupload">
                                                </div>
                                                <div class="preview-chooser">
                                                    <img id="preview1" class="preview-img" width="100%"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div id="preview-area2" class="preview-item">
                                                <div class="fileupload-icon">
                                                    <i class="glyphicon glyphicon-plus fileupload-icon-inner"></i>
                                                </div>
                                                <div class="fileupload-button">
                                                    <input id="fileupload2" data-role="none" type="file" name="fileupload2" class="fileupload">
                                                </div>
                                                <div class="preview-chooser">
                                                    <img id="preview2" class="preview-img"  width="100%"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div id="preview-area3" class="preview-item">
                                                <div class="fileupload-icon">
                                                    <i class="glyphicon glyphicon-plus fileupload-icon-inner"></i>
                                                </div>
                                                <div class="fileupload-button">
                                                    <input id="fileupload3" data-role="none" type="file" name="fileupload3" class="fileupload">
                                                </div>
                                                <div class="preview-chooser">
                                                    <img id="preview3" class="preview-img" width="100%"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div id="preview-area4" class="preview-item">
                                                <div class="fileupload-icon">
                                                    <i class="glyphicon glyphicon-plus fileupload-icon-inner"></i>
                                                </div>
                                                <div class="fileupload-button">
                                                    <input id="fileupload4" data-role="none" type="file" name="fileupload4" class="fileupload">
                                                </div>
                                                <div class="preview-chooser">
                                                    <img id="preview4" class="preview-img"  width="100%"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div id="preview-area5" class="preview-item">
                                                <div class="fileupload-icon">
                                                    <i class="glyphicon glyphicon-plus fileupload-icon-inner"></i>
                                                </div>
                                                <div class="fileupload-button">
                                                    <input id="fileupload5" data-role="none" type="file" name="fileupload5" class="fileupload">
                                                </div>
                                                <div class="preview-chooser">
                                                    <img id="preview5" class="preview-img" width="100%"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="upload-info-section" align="center">
                        <div id="fileinfo">
                            <div id="filename"></div>
                            <div id="filesize"></div>
                            <div id="filetype"></div>
                        ...
                        <div id="error">请选择有效格式的图片</div>
                        <div id="error2">上传出错，请重试</div>
                        <div id="abort">上传被中止或网络状态不稳定</div>
                        <div id="warnsize">上传文件过大，请选择较小的图片(<2M)</div>
                    ...
                    <div class="button-group-section" align="center">
                        <div id="button-upload" class="ui-button-custom button-to-upload" ></div>
                        <div id="button-music" class="ui-button-custom button-to-music" style="display: none"></div>
                    </div>
                </form>
            </div>
        </div>
...
<div data-role="page" id="view-submit" data-theme="d" class="view-submit-page">
    <div data-role="content">
        <div class="">
            ...
            <a id="button-preview" href="javascript:void(0)" class="button-preview-page ui-link"></a>
        </div>
    </div>
</div>
