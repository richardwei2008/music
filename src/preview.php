...
<html>
  ...
  <head>
      ...
      <link rel="stylesheet" href="css/my-app.preview.css">
...
<!--      <style type="text/css" media="screen">@import "plugins/slider/engine".$category."/style.css";</style>-->
  ...
  <div data-role="page" id="view-preview" data-theme="d" class="view-preview-page">
      <div data-role="content" class="ui-content-custom ">
          <div class="preview-page-fill"></div>
          ...
          <div class="preview-page-content">
              ...
              <div id="wowslider-container1">
                  <div class="ws_images">
                      <div id="share-cover" onClick="document.getElementById('share-cover').style.display='none';"  class="share-mask">
                          <img src="images/share-mask.png" width="100%" height="100%">
                      </div>
                      <ul>
...
<!--                <style type="text/css" media="screen">@import "plugins/slider/engine".$category."/script.js";</style>-->
          ...
          <div class="preview-page-footer">
              <div id="button-share" class="ui-button-custom button-to-share">
              </div>
          </div>
      </div>
  </div>
